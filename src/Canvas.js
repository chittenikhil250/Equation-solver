        ...
        <div className="container ">
          ...
          <div className="row">
            <div className="col-sm-12 col-md-6 offset-md-2">
              <h1 className='text-dark'>Draw the equation below</h1>
            </div>
          </div>
          <br/>
          <div className="align-items-center">
            <div className="col-12 col-md-6 border2 rounded border-dark offset-md-2">
            ...
            <center>
                  <button 
                    ...
                    className="btn btn-success ml-n5 mr-4 mt-5"
                    >
                  ...
                  <button 
                    ...
                    className="btn btn-danger rounded ml-1 mt-5"
                    >
                    Clear
                  </button>
            </center>
